...
namespace I2AIExtension.Editor.Views
{
    public class AiTranslateProviderView : BaseExtensionView
    {
        ...
        private void DrawAddProvider()
        {
            ...
            _newTranslateProviderSettings.ProviderType = (AiProviderType)EditorGUILayout.EnumPopup("Provider Type", _newTranslateProviderSettings.ProviderType,GUILayout.Width(200));
